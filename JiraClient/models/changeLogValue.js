...
const changeLogValueSchema = new mongoose.Schema({
    id: String,
    author: {
...
changeLogValueSchema.set('toJSON', {
...
const ChangeLogValue = mongoose.model('ChangeLogValue', changeLogValueSchema)

module.exports = ChangeLogValue
/**{
                "id": "10001",
                "author": {
